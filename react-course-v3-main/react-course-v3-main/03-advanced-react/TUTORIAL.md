...
If you want to update the state immediately and synchronously, you can pass a function to setState that receives the previous state as an argument and returns the new state.keep in mind that you can name the argument gien to function
anything.Instead of prevstate you can call it bobby lee or anything this state is provided by react by default
you dont have to do anything. For example:
